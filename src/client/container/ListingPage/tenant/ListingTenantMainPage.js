...
import TenantListingDashBoard from './TenantListingDashBoard';
...
export default class ListingTenantMainPage extends Component {
    ...
    getNumOfRoomMates()
    {
        ...
        if(this.context.currentListing.num_of_requested_roommates>0)
        {
            return (
                <>
                <div class="sub_title" style={{marginTop: "20px "}}>
                        Additional tenant?
                </div>
                <div class="_1ezjrwzo">
                ...
                <div className="col-3 wooden_background border" style={{textAlign:"center",borderStyle:"none ", height:"600px", marginLeft:"30px"}}>
                  ...
                  <div className="container" style={{borderStyle:"none ", marginTop:"40px"}}>
                    ...
                    <div className="row" style={{marginTop:"30px"}}>
                      ...
                      <div class="col-lg-4 sub_title wooden_background border rounded-top rounded-bottom" style={{maxHeight:"102px", textAlign: "center", marginLeft: "80px "}}>
