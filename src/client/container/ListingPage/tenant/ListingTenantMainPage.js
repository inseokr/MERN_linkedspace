    ...
    return (
        <div style={{ marginTop: '10px ', marginLeft: '-40px' }}>
          <ul style={{ listStyleType: 'none' }}>
            <li>
            {(currentListing.delegated_posting==undefined || currentListing.delegated_posting==false) &&
              <div style={{display:'flex'}}>
                <section className='_lsFont2' style={{marginTop: '0px'}}> Name: {currentListing.requester.username}</section>
              </div>}

              {(currentListing.delegated_posting==true) &&
              <div style={{display:'flex'}}>
                <section className='_lsFont2' style={{marginTop: '0px'}}> Name: {currentListing.posting_originator.username}</section>
              </div>}
