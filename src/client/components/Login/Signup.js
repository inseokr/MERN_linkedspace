...
export default function Signup() {
  ...
  function allowedYears() {
    ...
    let last_year       = cur_year.getFullYear() - minimum_age;
    let beginning_year = cur_year.getFullYear() - max_age;
  ...
  function getMonthOptions() {
    let listOfMonths = [];
    let monthStrings = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dev"];
