...
export default class ModalSignUpForm extends Component {
  state = { };
        ...
        <div className="modal-dialog" role="document">
          ...
          <div className="modal-content" style={modalContentStyle}>
            ...
            <div className="md-form mb-5 form-group" style={mdFormStyle}>
              <a href="/LS_API/signup/facebook"><img src={`${FILE_SERVER_URL}/public/user_resources/pictures/facebook_login.png`} style={facebookImgStyle} alt="Facebook" /></a>
            </div>
            ...
            <form action="/LS_API/signup/local" method="POST">

              <div className="modal-body form-group">

                <div className="md-form form-group" style={mdFormBottom}>
                  <label data-error="wrong" data-success="right" htmlFor="defaultForm-username" style={modalTitleStyle}>
                ...
                <div className="md-form form-group" style={mdFormBottom}>
                  <label data-error="wrong" data-success="right" htmlFor="defaultForm-pass" style={modalTitleStyle}>
                    <div className="input-group">
              ...
              <div className="modal-footer d-flex justify-content-center form-group">
                <button type="submit" className="btn btn-danger p-2 flex-grow-1">Signup</button>
              </div>
            </form>
          </div>
